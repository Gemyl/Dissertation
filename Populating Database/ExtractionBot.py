...
insert_organizations(cursor, orgName, orgType, orgAddress, orgPostalCode, orgCity, orgState, orgCountry, orgNameVariants)
...
# pubDOI, orgNameTemp = papers_and_orgs(DOIs, orgID, orgName)
# print('Inserting papers-organizations matching data to database:')
# insert_publications_and_organizations(cursor, pubDOI, orgNameTemp)

# print('\nMatching authors with organizations:')
# authorID, orgNameTemp = authors_and_organizations(DOIs, orgID, orgName)
# print('Inserting authors-organizations mathcing data to database:')
# insert_authors_and_organizations(cursor, authorID, orgNameTemp)
